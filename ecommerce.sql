...
-- Tiempo de generación: 27-09-2020 a las 22:49:19
...
(7, 1, 6, 'Hola, si aun tenemos 11 productos en sotock.', 0, 'ADMIN', 'usuarioDosprueba', '15 / 8 / 2020  -  14:25:0'),
(8, 6, 1, 'ok, muchas gracias!!!', 7, 'usuarioDosprueba', 'ADMIN', '15 / 8 / 2020  -  15:58:57'),
...
(14, 1, 'Huawei P40 pro', '90000', 'El mejor celu del mundo....\r\nContiene todas las funciones.', 'image-1600918898778.jpeg', 1, 0);
...
INSERT INTO `promotions` (`id`, `products_id`, `description`) VALUES
(1, 2, 'Promocion de la primavera si compras 2 iphone te hacemos 20% de descuento.'),
